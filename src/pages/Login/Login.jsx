    ...
    <div className="min-h-screen bg-secondary flex items-center justify-center p-4">
      <div className="bg-primary w-full max-w-[662px] rounded-2xl shadow-sm p-6 md:p-12">
        <div className="text-center mb-8">
          ...
          <h1 className="type-h2 text-txt mb-2 leading-tight">Welcome Back</h1>
          <p className="type-p text-paragraph text-sm md:text-base">Sign in to your account to continue</p>
        </div>
        ...
        <div className="flex bg-secondary p-1 rounded-xl mb-8 border border-gray-100">
          ...
          >
            ...
            <span className="truncate">
              {/* This span hides the long text on mobile but keeps it on desktop */}
              <span className="hidden sm:inline">Sign in as </span>Renter
            </span>
          </button>
          <button
          ...
          >
            ...
            <span className="truncate">
              <span className="hidden sm:inline">Sign in as </span>Lender
            </span>
          </button>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link to="/forgot-password" n className="text-xs font-bold text-accent hover:underline">
                Forgot Password?
              </Link>
            </div>
          ...
          <button className="w-full bg-accent hover:opacity-95 transition-all text-txt type-p font-bold py-4 rounded-lg shadow-md mt-2">
        ...
        <div className="relative flex py-8 items-center">
          ...
          <span className="flex-shrink-0 mx-4 type-small text-paragraph font-medium">or continue with</span>
          <div className="flex-grow border-t border-gray-100"></div>
        </div>
