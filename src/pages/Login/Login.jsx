      ...
      <div className="bg-primary w-full max-w-[662px] rounded-2xl shadow-sm p-8 md:p-12">
        ...
        <form className="space-y-5">
          <div className="space-y-1.5">
            <label className="type-small font-medium text-txt">
              Email Address
            </label>
            <input
              type="email"
        ...
        <div className="relative flex py-6 items-center">
          ...
          <span className="flex-shrink-0 mx-4 type-small text-paragraph">
            or continue with
          </span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-2 border border-gray-200 hover:bg-secondary transition-colors py-3 rounded-lg">
            ...
            <span className="type-small font-medium text-txt leading-none pt-0.5">
              Google
            </span>
          </button>
