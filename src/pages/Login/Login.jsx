    ...
    <div className="min-h-screen bg-secondary flex items-center justify-center p-4">
      <div className="bg-primary w-full max-w-[662px] rounded-2xl shadow-sm p-8 md:p-12">
        <div className="text-center mb-8">
          ...
          <h1 className="type-h2 text-txt mb-2">Welcome Back</h1>
          <p className="type-p text-paragraph">Sign in to your account to continue</p>
        </div>
        ...
        <form className="space-y-5">
          <div className="space-y-1.5">
            ...
            <input type="email" placeholder="your@gmail.com" className="w-full bg-secondary text-txt type-small px-4 py-3 rounded-lg border-none focus:ring-2 focus:ring-accent outline-none" />
          </div>

          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              <label className="type-small font-medium text-txt">Password</label>
              <Link to="/forgot-password" n className="text-sm font-medium text-accent hover:underline">
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
              <input type={showPassword ? "text" : "password"} placeholder="password" className="w-full bg-secondary text-txt type-small px-4 py-3 rounded-lg border-none focus:ring-2 focus:ring-accent outline-none" />
        ...
        <div className="relative flex py-6 items-center">
          ...
          <span className="flex-shrink-0 mx-4 type-small text-paragraph">or continue with</span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>

        {/* SOCIAL BUTTONS (RESTORED LOGOS) */}
        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-2 border border-gray-200 hover:bg-secondary py-3 rounded-lg transition-colors">
            ...
            <span className="type-small font-medium text-txt">Google</span>
          </button>
          <button className="flex items-center justify-center gap-2 border border-gray-200 hover:bg-secondary py-3 rounded-lg transition-colors">
            ...
            <span className="type-small font-medium text-txt">Facebook</span>
          </button>
        </div>
