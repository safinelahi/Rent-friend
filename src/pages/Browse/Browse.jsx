...
const Browse = () => {
  ...
  // Refactored Filter Content using Standard Utilities
  const FilterContent = () => (
    <div className="space-y-8">
      <div className="flex items-center justify-between lg:justify-start gap-2 text-[#333333] font-bold uppercase tracking-widest text-[11px]">
      ...
      <button
        ...
        className="w-full py-4 bg-[#faf9f4] text-[#333333] font-bold text-[10px] uppercase tracking-widest rounded-2xl hover:bg-gray-200 transition-all flex items-center justify-center gap-2"
      >
        <FiX /> Reset All
      </button>
    </div>
